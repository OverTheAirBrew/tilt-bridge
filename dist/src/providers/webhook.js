...
let WebhookProvider = class WebhookProvider extends provider_1.Provider {
    constructor() {
        super('webhook');
    }
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(splitUrls.map((url) => __awaiter(this, void 0, void 0, function* () {
                yield this.makeRequest(url, latestValues);
                this.logger.info(`SENT DATA TO ${url}`, latestValues);
            })));
        });
    }
};
WebhookProvider = __decorate([
    (0, typedi_1.Service)(),
